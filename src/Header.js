...
export default function Header () {
    ...
    <header className="container">
        <nav
            className="flex flex-wrap  md:justify-around md:py-4 bg-blue-800/80 backdrop-blur-md shadow-md w-full fixed top-0 left-0 right-0 z-20 px-8 md:px-3">
            <ul
                className="items-center flex flex-row space-x-2 md:space-x-8 justify-center justify-items-start md:justify-items-center md:flex md:pt-2 w-full left-0 top-16 px-5 md:px-10 py-3 md:py-0 border-t md:border-t-0">
