    ...
    <header className="container">
        <nav
            ...
            <ul
                ...
                <li><Link activeClass="font-extrabold text-purple-400" to="recent-work" spy={true} smooth={true} className="flex text-blue-100 hover:text-blue-500 cursor-pointer transition-colors duration-300 font-semibold">Previous Work</Link></li>
