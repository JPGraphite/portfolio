...
function LandingPage() {
  return (
        <Fragment>
            <main className="flex flex-col items-center justify-center mt-[4.6rem]">
                ...
                {/* Parallax Background  */}
                <section
                    className="flex flex-wrap w-full h-[500px] bg-cover bg-fixed bg-center flex justify-center items-center"
                    style={{
                    ...
                    <div className="w-full h-full mx-20">
                        ...
                        <p className="text-3xl font-bold">Based in <span className="text-black">Geelong, Victora</span></p>
                        </div>
                    </div>
                ...
                <div className="pt-2">
                    <div
                        ...
                        <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
                            <a href="/test" className="w-6 mx-1">
